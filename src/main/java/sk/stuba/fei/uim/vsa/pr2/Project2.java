...
public class Project2 {
    ...
    public static final Class<? extends Application> APPLICATION_CLASS = CP_Application.class;
    ...
    public static void postStart() {
        ...
        //carParkService.createUser("admin","admin","admin@vsa.sk");
        //carParkService.createCarPark("juh","jojo",12,2L);
//        CAR_PARK park=new CAR_PARK();
//        park.setId(2L);
//        park.setName("JUH1");
//        carParkService.updateCarPark(park);
    }
