...
public abstract class AbstractCarParkService {
     ...
     */
    public abstract CAR_PARK createCarPark(String name, String address, Integer pricePerHour,Long id);
     ...
     * @return objekt entity parkovacieho domu
     */
    public abstract CAR_PARK getCarPark(Long carParkId);
     ...
     * @return objekt entity parkovacieho domu
     */
    public abstract CAR_PARK getCarPark(String carParkName);
     ...
     */
    public abstract List<CAR_PARK> getCarParks();
     ...
     */
    public abstract CAR_PARK updateCarPark(Object carPark);
     ...
     */
    public abstract CAR_PARK deleteCarPark(Long carParkId);
     ...
     */
    public abstract CAR_PARK_FLOOR createCarParkFloor(Long carParkId, String floorIdentifier);
     ...
     * @return objekt entity poschodia
     */
    public abstract CAR_PARK_FLOOR getCarParkFloor(Long carParkFloorId);
     ...
     */
    public abstract List<CAR_PARK_FLOOR> getCarParkFloors(Long carParkId);
     ...
     * @return vymazaná entita poschodia
     */
    public abstract CAR_PARK_FLOOR deleteCarParkFloor(Long carParkFloorId);
     ...
     */
    public abstract PARKING_SPOT createParkingSpot(Long carParkId, String floorIdentifier, String spotIdentifier);
     ...
     * @return objekt entity parkovacieho miesta
     */
    public abstract PARKING_SPOT getParkingSpot(Long parkingSpotId);
     ...
     */
    public abstract List<PARKING_SPOT> getParkingSpots(Long carParkId, String floorIdentifier);
     ...
     */
    public abstract Map<String, List<PARKING_SPOT>> getParkingSpots(Long carParkId);
     ...
     */
    public abstract Map<String, List<PARKING_SPOT>> getAvailableParkingSpots(String carParkName);
     ...
     */
    public abstract Map<String, List<PARKING_SPOT>> getOccupiedParkingSpots(String carParkName);
     ...
     */
    public abstract PARKING_SPOT updateParkingSpot(Object parkingSpot);
     ...
     */
    public abstract PARKING_SPOT deleteParkingSpot(Long parkingSpotId);
     ...
     */
    public abstract CAR createCar(Long userId, String brand, String model, String colour, String vehicleRegistrationPlate);
     ...
     */
    public abstract RESERVATION createReservation(Long parkingSpotId, Long cardId);
     ...
     */
    public abstract CAR_TYPE createCarType(String name);
     ...
     */
    public abstract List<CAR_TYPE> getCarTypes();
     ...
     * @return objekt entity typu auta
     */
    public abstract CAR_TYPE getCarType(Long carTypeId);
     ...
     * @return objekt entity typu auta
     */
    public abstract CAR_TYPE getCarType(String name);
     ...
     * @return objekt entity auta
     */
    public abstract CAR createCar(Long userId, String brand, String model, String colour, String vehicleRegistrationPlate, Long carTypeId);
     ...
     * @return objekt entity parkovacieho miesta
     */
    public abstract PARKING_SPOT createParkingSpot(Long carParkId, String floorIdentifier, String spotIdentifier, Long carTypeId);

    public abstract List<CAR> getCars();

    public abstract CAR_TYPE createCarType(Long id,String name);
